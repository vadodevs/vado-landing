...
const TERMS_DESCRIPTION =
  'Legal terms for Vado Devs LLC services: agreement, intellectual property, user obligations, privacy, and contact.';

const TOC_ITEMS = [
  { id: 'our-services', label: '1. Our Services' },
  { id: 'intellectual-property', label: '2. Intellectual Property Rights' },
  { id: 'user-representations', label: '3. User Representations' },
  { id: 'user-registration', label: '4. User Registration' },
  { id: 'purchases', label: '5. Purchases and Payment' },
  { id: 'prohibited-activities', label: '6. Prohibited Activities' },
  { id: 'user-contributions', label: '7. User Generated Contributions' },
  { id: 'contribution-license', label: '8. Contribution License' },
  { id: 'services-management', label: '9. Services Management' },
  { id: 'privacy-policy', label: '10. Privacy Policy' },
  { id: 'copyright-infringements', label: '11. Copyright Infringements' },
  { id: 'term-termination', label: '12. Term and Termination' },
  { id: 'modifications', label: '13. Modifications and Interruptions' },
  { id: 'governing-law', label: '14. Governing Law' },
  { id: 'dispute-resolution', label: '15. Dispute Resolution' },
  { id: 'corrections', label: '16. Corrections' },
  { id: 'disclaimer', label: '17. Disclaimer' },
  { id: 'limitations', label: '18. Limitations of Liability' },
  { id: 'indemnification', label: '19. Indemnification' },
  { id: 'user-data', label: '20. User Data' },
  { id: 'electronic-communications', label: '21. Electronic Communications, Transactions, and Signatures' },
  { id: 'sms', label: '22. SMS Text Messaging' },
  { id: 'california-users', label: '23. California Users and Residents' },
  { id: 'miscellaneous', label: '24. Miscellaneous' },
  { id: 'contact-us', label: '25. Contact Us' },
];

export default function TerminosDelServicio() {
  const { path } = useLocale();
  const canonicalPath = path('/terminos');
          ...
          <CenterContainer>
            ...
            >
              <header className="flex flex-col gap-2">
                <h1 className="text-2xl font-bold uppercase">{TERMS_TITLE}</h1>
                <p className="text-muted-foreground font-semibold">
                  Last updated <time dateTime="2024-10-25">October 25, 2024</time>
                </p>
              </header>

              <section className="flex flex-col gap-6" aria-labelledby="agreement">
                <h2 id="agreement" className="text-xl font-bold uppercase">
                  Agreement to our legal terms
                </h2>
                <p>
                  We are Vado Devs LLC, doing business as Vado (&quot;Company,&quot;
                  &quot;we,&quot; &quot;us,&quot; &quot;our&quot;), a company registered in
                  Delaware, United States at 8 The Green Ste B, Dover, DE, 19901.
                </p>
                <p>
                  We operate the website{' '}
                  <a href="https://www.vadodevs.com" className="text-primary hover:underline">
                ...
                <p>
                  ...
                  <a href="tel:308-279-8206" className="text-primary hover:underline">
                    308-279-8206
                  </a>
                  , email at{' '}
                  <a href="mailto:contact@vadodevs.com" className="text-primary hover:underline">
                    contact@vadodevs.com
                  </a>
                  , or by mail to 8 The Green Ste B, Dover, DE 19901, United States.
                </p>
                <p>
                  These Legal Terms constitute a legally binding agreement made between you,
                  whether personally or on behalf of an entity (&quot;you&quot;), and Vado
                  Devs LLC, concerning your access to and use of the Services. You agree
                ...
                <ol className="space-y-1 text-primary text-sm md:text-base">
                  {TOC_ITEMS.map((item) => (
                    <li key={item.id}>
                      <a
                        href={`#${item.id}`}
                        className="font-semibold uppercase tracking-tight hover:underline"
                      >
                        {item.label}
                      </a>
                    </li>
              ...
              <section className="flex flex-col gap-6" aria-labelledby="our-services">
                <h2 id="our-services" className="text-xl font-bold uppercase">
                  1. Our Services
                </h2>
                <p>
              ...
              <section className="flex flex-col gap-6" aria-labelledby="intellectual-property">
                <h2 id="intellectual-property" className="text-xl font-bold uppercase">
                  2. Intellectual Property Rights
                </h2>
                <h3 className="text-lg font-bold">Our intellectual property</h3>
                <p>
                ...
                <h3 className="text-lg font-bold">Your use of our Services</h3>
                <p>
                  ...
                  Services; and download or print a copy of any portion of the Content
                  to which you have properly gained access. solely for your internal
                  business purpose.
                </p>
                <p>
                ...
                <h3 className="text-lg font-bold">Your submissions and contributions</h3>
                <p>
                ...
                <p>
                  <strong className="font-semibold">Submissions:</strong> By directly
                ...
                <p>
                  <strong className="font-semibold">Contributions:</strong> The Services
                  ...
                  you may create, submit, post, display, transmit, publish, distribute,
                  or broadcast content and materials to us or through the Services,
                ...
                <p>
                  <strong className="font-semibold">We may remove or edit your Content:</strong>{' '}
                ...
                <h3 className="text-lg font-bold">Copyright infringement</h3>
                <p>
              ...
              <section className="flex flex-col gap-6" aria-labelledby="user-representations">
                <h2 id="user-representations" className="text-xl font-bold uppercase">
              ...
              <section className="flex flex-col gap-6" aria-labelledby="user-registration">
                <h2 id="user-registration" className="text-xl font-bold uppercase">
                  4. User Registration
                </h2>
                <p>
              ...
              <section className="flex flex-col gap-6" aria-labelledby="purchases">
                <h2 id="purchases" className="text-xl font-bold uppercase">
              ...
              <section className="flex flex-col gap-6" aria-labelledby="prohibited-activities">
                <h2 id="prohibited-activities" className="text-xl font-bold uppercase">
              ...
              <section className="flex flex-col gap-6" aria-labelledby="user-contributions">
                <h2 id="user-contributions" className="text-xl font-bold uppercase">
              ...
              <section className="flex flex-col gap-6" aria-labelledby="contribution-license">
                <h2 id="contribution-license" className="text-xl font-bold uppercase">
                ...
                <p>
                  ...
                  the Services; and (3) to pre-screen or delete any Contributions at
                  any time and for any reason, without notice. We have no obligation to
                  monitor your Contributions.
                </p>
              </section>

              <section className="flex flex-col gap-6" aria-labelledby="services-management">
                <h2 id="services-management" className="text-xl font-bold uppercase">
                ...
                <p>
                  ...
                  the law or these Legal Terms, including without limitation, reporting
              ...
              <section className="flex flex-col gap-6" aria-labelledby="privacy-policy">
                <h2 id="privacy-policy" className="text-xl font-bold uppercase">
                  10. Privacy Policy
                </h2>
                <p>
                  We care about data privacy and security. Please review our{' '}
                  <a href={path('/politica-privacidad')} className="text-primary hover:underline">
                    Privacy Policy
                  </a>
              ...
              <section className="flex flex-col gap-6" aria-labelledby="copyright-infringements">
                <h2 id="copyright-infringements" className="text-xl font-bold uppercase">
              ...
              <section className="flex flex-col gap-6" aria-labelledby="term-termination">
                <h2 id="term-termination" className="text-xl font-bold uppercase">
              ...
              <section className="flex flex-col gap-6" aria-labelledby="modifications">
                <h2 id="modifications" className="text-xl font-bold uppercase">
              ...
              <section className="flex flex-col gap-6" aria-labelledby="governing-law">
                <h2 id="governing-law" className="text-xl font-bold uppercase">
                  14. Governing Law
                </h2>
                <p>
              ...
              <section className="flex flex-col gap-6" aria-labelledby="dispute-resolution">
                <h2 id="dispute-resolution" className="text-xl font-bold uppercase">
                  15. Dispute Resolution
                </h2>
                <h3 className="text-lg font-bold">Informal Negotiations</h3>
                <p>
                ...
                <h3 className="text-lg font-bold">Binding Arbitration</h3>
                <p>
                  ...
                  share of arbitrator compensation shall be governed by the AAA
                  ...
                  place in Delaware. Except as otherwise provided herein, the Parties
                ...
                <p>
                  ...
                  state and federal courts located in Delaware, and the Parties
                ...
                <h3 className="text-lg font-bold">Exceptions to Informal Negotiations and Arbitration</h3>
                <p>
              ...
              <section className="flex flex-col gap-6" aria-labelledby="corrections">
                <h2 id="corrections" className="text-xl font-bold uppercase">
                  16. Corrections
                </h2>
                <p>
              ...
              <section className="flex flex-col gap-6" aria-labelledby="disclaimer">
                <h2 id="disclaimer" className="text-xl font-bold uppercase">
                  17. Disclaimer
                </h2>
              ...
              <section className="flex flex-col gap-6" aria-labelledby="limitations">
                <h2 id="limitations" className="text-xl font-bold uppercase">
              ...
              <section className="flex flex-col gap-6" aria-labelledby="indemnification">
                <h2 id="indemnification" className="text-xl font-bold uppercase">
                  19. Indemnification
                </h2>
                <p>
              ...
              <section className="flex flex-col gap-6" aria-labelledby="user-data">
                <h2 id="user-data" className="text-xl font-bold uppercase">
                  20. User Data
                </h2>
                <p>
              ...
              <section className="flex flex-col gap-6" aria-labelledby="electronic-communications">
                <h2 id="electronic-communications" className="text-xl font-bold uppercase">
              ...
              <section className="flex flex-col gap-6" aria-labelledby="sms">
                <h2 id="sms" className="text-xl font-bold uppercase">
                ...
                <h3 className="text-lg font-bold">Message and Data Rates</h3>
                <p>
              ...
              <section className="flex flex-col gap-6" aria-labelledby="california-users">
                <h2 id="california-users" className="text-xl font-bold uppercase">
              ...
              <section className="flex flex-col gap-6" aria-labelledby="miscellaneous">
                <h2 id="miscellaneous" className="text-xl font-bold uppercase">
                  24. Miscellaneous
                </h2>
                <p>
                  ...
                  not operate as a waiver of such right or provision. These Legal
                  Terms operate to the fullest extent permissible by law. We may
              ...
              <section className="flex flex-col gap-6" aria-labelledby="contact-us">
                <h2 id="contact-us" className="text-xl font-bold uppercase">
                  25. Contact Us
                </h2>
                <p>
