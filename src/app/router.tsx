...
export function Router() {
  return (
    <>
      ...
      <Route path="/:lang/app/recruiter/desarrolladores" component={AppRecruiterDesarrolladoresPage} />
      ...
      <Route path="/:lang/app/recruiter/ofertas/preview/:id" component={AppRecruiterOfertasPage} />
      <Route
        path="/:lang/app/recruiter/ofertas/:jobId/candidatos/:applicantId"
        component={AppRecruiterOfertasCandidatoPerfilPage}
      />
      <Route path="/:lang/app/recruiter/ofertas/:id/candidatos" component={AppRecruiterOfertasCandidatosPage} />
      ...
      <Route path="/:lang/app/admin/ofertas/:jobId/candidatos/:applicantId" component={AppAdminOfertasCandidatoPerfilPage} />
      <Route path="/:lang/app/admin/ofertas/:id/candidatos" component={AppAdminOfertasCandidatosPage} />
