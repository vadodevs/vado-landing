...
import {
  NavigationMenu as NavigationMenuRootPrimitive,
...
function NavigationMenu({
  ...
  viewport = true,
  ...props
}: React.ComponentProps<typeof NavigationMenuRootPrimitive> & {
  viewport?: boolean;
}) {
  return (
