...
import { Globe2, Gauge, Puzzle, SlidersHorizontal, BookOpenCheck, Radio } from 'lucide-react';
import type { LucideIcon } from 'lucide-react';

const BENTO_ITEMS: { titleKey: string; descriptionKey: string; icon: LucideIcon; className: string }[] = [
  {
    titleKey: 'home.nearshoreBento.item1Title',
    descriptionKey: 'home.nearshoreBento.item1Description',
    icon: Globe2,
    className:
      'border-sky-200/80 bg-gradient-to-br from-sky-100/95 via-sky-50/90 to-cyan-50/80 text-sky-950 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.65)] sm:col-span-2 xl:col-span-5 xl:row-span-2',
  },
  {
    ...
    icon: Gauge,
    className:
      'border-violet-200/80 bg-gradient-to-br from-violet-100/90 to-fuchsia-50/75 text-violet-950 xl:col-span-7',
  },
  {
    ...
    icon: Puzzle,
    className:
      'border-amber-200/80 bg-gradient-to-br from-amber-100/90 to-orange-50/70 text-amber-950 xl:col-span-4',
  },
  {
    ...
    className:
      'border-emerald-200/80 bg-gradient-to-br from-emerald-100/90 to-teal-50/75 text-emerald-950 xl:col-span-3',
  },
  {
    ...
    icon: BookOpenCheck,
    className:
      'border-rose-200/80 bg-gradient-to-br from-rose-100/88 to-pink-50/72 text-rose-950 xl:col-span-5',
  },
  {
    titleKey: 'home.nearshoreBento.item6Title',
    descriptionKey: 'home.nearshoreBento.item6Description',
    icon: Radio,
    className:
      'border-indigo-200/80 bg-gradient-to-br from-indigo-100/90 via-blue-50/80 to-slate-50/70 text-indigo-950 sm:col-span-2 xl:col-span-12',
  },
];
    ...
    <section className="border-t border-neutral-200 bg-gradient-to-b from-neutral-50 to-white py-14 md:py-20 lg:py-24">
      <CenterContainer>
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-12 xl:grid-rows-2 xl:gap-5">
            {BENTO_ITEMS.map((item) => {
              ...
              return (
                <article
                  key={item.titleKey}
                  className={cn(
                    'flex flex-col rounded-3xl border p-6 shadow-sm md:p-7',
                    item.className,
                  )}
                >
                  <span
