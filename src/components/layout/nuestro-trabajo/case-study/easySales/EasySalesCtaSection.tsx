...
export function EasySalesCtaSection() {
        ...
        >
          <h2 className="mb-4 text-2xl leading-tight font-bold tracking-tight uppercase md:text-3xl lg:text-4xl">
            <span className="block" style={{ color: CTA_TITLE_DARK }}>
              {t('ourWork.caseStudy.easySales.cta.titleLine1')}
            </span>
            <span className="block" style={{ color: EASY_SALES_ACCENT }}>
              {t('ourWork.caseStudy.easySales.cta.titleLine2')}
            </span>
          </h2>
          <p className="text-muted-foreground mb-8 text-base leading-relaxed md:text-lg">
            {t('ourWork.caseStudy.easySales.cta.description')}
          </p>
          <Button
            size="lg"
          ...
          >
            <Link href={path('/contacto')}>
              {t('ourWork.caseStudy.easySales.cta.ctaLabel')}
            </Link>
          </Button>
        </motion.div>
      </div>
