export const DIGITAL_RANCH_ACCENT = '#00681c';

export function Accent({ children }: { children: React.ReactNode }) {
  return (
    <span className="font-semibold" style={{ color: DIGITAL_RANCH_ACCENT }}>
      {children}
    </span>
  );
}

export function DigitalRanchCaseSection({
  label,
  title,
  children,
  reverse,
              ...
              (variant === 'default' ? (
                ...
                title && (
                  <h2
                    ...
                    style={{ borderColor: DIGITAL_RANCH_ACCENT }}
                  >
                    {title}
                  </h2>
                )
