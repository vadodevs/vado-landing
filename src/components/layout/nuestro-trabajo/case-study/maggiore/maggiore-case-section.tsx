...
export function Accent({ children }: { children: React.ReactNode }) {
  return (
    <span className="font-semibold" style={{ color: MAGGIORE_ACCENT }}>
      {children}
    </span>
  );
}

export function MaggioreCaseSection({
  label,
  title,
  children,
  reverse,
  ...
  return (
    <section className="w-full py-12 md:py-16 lg:py-20">
      <div className="w-full min-w-0">
        <div
          className={
            'flex w-full flex-col gap-10 lg:items-center lg:gap-16 ' +
              ...
              (variant === 'default' ? (
                ...
                title && (
                  <h2
                    ...
                    style={{ borderColor: MAGGIORE_ACCENT }}
                  >
                    {title}
                  </h2>
                )
