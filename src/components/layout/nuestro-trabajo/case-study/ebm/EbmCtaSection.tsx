        ...
        >
          <h2 className="mb-4 text-2xl leading-tight font-bold tracking-tight uppercase md:text-3xl lg:text-4xl">
            <span className="block" style={{ color: CTA_TITLE_DARK }}>
              {t('ourWork.caseStudy.ebm.cta.titleLine1')}
            </span>
            <span className="block" style={{ color: EBM_ACCENT }}>
              {t('ourWork.caseStudy.ebm.cta.titleLine2')}
            </span>
          </h2>
          <p className="text-muted-foreground mb-8 text-base leading-relaxed md:text-lg">
            {t('ourWork.caseStudy.ebm.cta.description')}
          </p>
          <Button
            size="lg"
            ...
            asChild
          >
            <Link href={path('/contacto')}>{t('ourWork.caseStudy.ebm.cta.ctaLabel')}</Link>
          </Button>
        </motion.div>
      </div>
    </section>
