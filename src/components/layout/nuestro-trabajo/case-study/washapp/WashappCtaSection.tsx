...
export function WashappCtaSection() {
        ...
        >
          <h2 className="mb-4 text-2xl leading-tight font-bold tracking-tight uppercase md:text-3xl lg:text-4xl">
            <span className="block" style={{ color: CTA_TITLE_DARK }}>
              {t('ourWork.caseStudy.washapp.cta.titleLine1')}
            </span>
            <span className="block" style={{ color: WASHAPP_ACCENT }}>
              {t('ourWork.caseStudy.washapp.cta.titleLine2')}
            </span>
          </h2>
          <p className="text-muted-foreground mb-8 text-base leading-relaxed md:text-lg">
            {t('ourWork.caseStudy.washapp.cta.description')}
          </p>
          <Button
            size="lg"
            className="rounded-xl px-8 py-6 text-base font-semibold shadow-md transition-all hover:shadow-lg"
            style={{ backgroundColor: WASHAPP_ACCENT, color: 'white' }}
            asChild
          >
            <Link href={path('/contacto')}>{t('ourWork.caseStudy.washapp.cta.ctaLabel')}</Link>
          </Button>
        </motion.div>
      </div>
    </section>
